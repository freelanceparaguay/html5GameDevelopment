							...
							if (i != j) {
								if (sprites[j].visible) {
									...
									if (hitTestCircle(sprites[i], sprites[j])) {
										...
										//only block them
										if ((sprites[i].type == BUG_TYPE1 || sprites[i].type == BUG_TYPE2 || sprites[i].type == BUG_TYPE3) && (sprites[j].type == BUG_TYPE1 || sprites[j].type == BUG_TYPE2 || sprites[j].type == BUG_TYPE3)) {
